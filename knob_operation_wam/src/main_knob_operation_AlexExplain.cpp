...
bool main_srvJointMove(knob_operation_wam::JointMove::Request &req,knob_operation_wam::JointMove::Request &res) {
    srv_joint_move.call();
}
...
//  success = KnobOperationWAM(CurJointWAM, isRevDir, PoseKnobWrtWAM);
  ...
  if (success == 1){
      ...
      for (int i=0;i<30;i++){
          ...
          knob_operation_wam::JointMove::Request req;
          knob_operation_wam::JointMove::Response res;
          req.joints[]
          bool status = main_srvJointMove(req,res);
...
int main(int argc, char ** argv)
{
    ...
    srv_joint_move_wam = nh_.advertiseService("knob_operation_wam/joint_move_wam", main_srvJointMove);
